...
### 5. Тестирование API через Swagger UI

> *[Вставьте скриншот тестирования запроса в Swagger UI]*
...
**Реализовано:**
- ✅ Интеграция Swagger в Express-сервер
- ✅ Документирование всех CRUD-операций через JSDoc
- ✅ Описание схемы User в спецификации OpenAPI
